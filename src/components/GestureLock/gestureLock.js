    ...
    for (let i = 0; i < 3; i++) {
      for (let j = 0; j < 3; j++) {
        ...
        this.circleArray.push({
          ...
          radius: this.cycleRadius,
          check: false,
          style: {
            left: (cycleMargin + this.cycleRadius) * (j * 2 + 1) - this.cycleRadius + 'px',
            top: (cycleMargin + this.cycleRadius) * (i * 2 + 1) - this.cycleRadius + 'px',
            width: this.cycleRadius * 2 + 'px',
          }
        });
      }
    }
